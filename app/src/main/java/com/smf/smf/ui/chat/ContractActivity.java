...
import com.smf.smf.SMFApplication;
import com.smf.smf.data.model.Contact;
...
public class ContractActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
    ...
    private void fetchContacts() {
        ...
        SMFApplication.getInstance().addToRequestQueue(request);
    }
